 ...
 * @Author: Shilong Song
 * @CreateTime: 2024-12-23  21:40
 * @Description: UserRegisterErrorCodeEnum
 * @Version: 1.0
 */
@AllArgsConstructor
public enum UserRegisterErrorCodeEnum implements ErrorCode {
    ...
    ID_CARD_REPEAT_REGISTER("A006016", "证件号重复注册超过5次，已加入黑名单");
