...
public class GlobalExceptionHandler {
    ...
    public Result<Void> validExceptionHandler(HttpServletRequest request, MethodArgumentNotValidException exception) {
        ...
        return ResponseData.failure(BaseErrorCode.CLIENT_ERROR.code(), message);
    }

    @ExceptionHandler(value = AbstractException.class)
    public Result<Void> validAbstractException(HttpServletRequest request, AbstractException exception) {
        log.error("[MethodName: {}], RequestRI: [{}], {}", request.getMethod(), parseRequestUrl(request), exception.toString());
        return ResponseData.failure(exception);
    }
