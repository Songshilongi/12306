...
import com.songshilong.framework.starter.base.Singleton;
import com.songshilong.framework.starter.cache.config.RedisDistributedProperties;
import com.songshilong.framework.starter.cache.core.CacheGetFilter;
import com.songshilong.framework.starter.cache.core.CacheGetIfAbsent;
import com.songshilong.framework.starter.cache.core.CacheLoader;
import com.songshilong.framework.starter.cache.toolkit.CacheUtil;
import com.songshilong.framework.starter.cache.toolkit.FastJson2Util;
 ...
 * @Author: Shilong Song
 * @CreateTime: 2024-12-21  15:49
 * @Description: StringRedisTemplateProxy
 * @Version: 1.0
 */
...
public class StringRedisTemplateProxy implements DistributedCache{
    ...
    public Boolean putIfAllAbsent(@NotNull Collection<String> keys) {
        DefaultRedisScript<Boolean> actual = (DefaultRedisScript<Boolean>) Singleton.get(LUA_PUT_IF_ALL_ABSENT_SCRIPT_PATH, () -> {
