...
import com.songshilong.framework.starter.cache.RedisKeySerializer;
import com.songshilong.framework.starter.cache.StringRedisTemplateProxy;
...
public class CacheAutoConfiguration {
    ...
    /**
     * Redis静态代理
     * @param redisKeySerializer redis序列化器
     * @param stringRedisTemplate redis template
     * @param redissonClient redis 客户端
     * @return {@link StringRedisTemplateProxy}
     */
    @Bean
